...
(function () {
  ...
  var REL = {
    ...
    'aic-case-4.html': {
      needs: [{ file: 'aic-case-3.html', why: 'Skills 是演化出来的——别人的演化不等于你的' }],
    ...
    /* ── 实战五 · AI 工程设计模式（2026-09-20 发布，已补外向关联）── */
    'aic-d-10-1.html': {
      needs: [{ file: '10-1.html', why: '通用版：Workflow 与 Agent 的定义与机制（本页为电商场景版）' }],
      terms: [
        { t: '挑活三筛：这活值不值得交出去', file: 'aic-team-4.html' },
        { t: '交给 AI 还是交给脚本：两个维度', file: 'aic-case-3.html' },
      ],
      next: [
        { file: 'aic-d-10-2.html', why: '决定写死之后，这几步怎么排' },
        { file: 'aic-case-1.html', why: '实例：叫 Agent 的巡检里，固定的那几段仍是流程' },
      ],
    },
    'aic-d-10-2.html': {
      needs: [
        { file: 'aic-d-10-1.html', why: '先判该不该写死，再谈怎么排' },
        { file: '10-2.html', why: '通用版：五种模式的原理、原图与调度器动画（本页为电商场景版）' },
      ],
      terms: [
        { t: '挑刺清单里的标题与五点口径', file: 'aic-listing-4.html' },
        { t: '投票降随机，但不治编数字', file: '1-2-hallucination.html' },
      ],
      next: [
        { file: 'aic-case-3.html', why: '把排法固化下来，就是一份 Skills' },
        { file: 'aic-listing-3.html', why: '文案定稿只是自检，对错交给上架实验' },
      ],
    },
  };
